...
// improt java.lang; >>알게모르게 포함되어 있음
public class B_ArrayCopy {
	...
	public void method4() {
		 ...
		 *java.util.Scanner
		 *java.uil.Arrays
		 *>>java.lang 이외의 패키지에 있는 클래스들을 쓸 때는 무조껀 import해야됨
		 */
		...
		System.out.println();	
			 ...
			 * >>내가 제시한 길이가 원본 배열의 크기보다 클 경우 기존의 배열에 값은 다 복사 나머지 0으로 채운다.
			 * >> 내가 제시한 길이가 원본배열의 크기보다 작을 경우 기존의 배열에 있는 값 내가 제시한 길이 만큼만 복사
			 * 
			 * 
			 */
			System.out.println("origin주소값 :"+origin.hashCode());
