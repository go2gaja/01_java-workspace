...
public class A_If {
	...
	//단 이 순차적인 흐름을 바꾸고자 한다면 제어문이라는걸 이용해서 직접 제어 가능
	...
	//조건식의 결과 true/false 여야한다
	//보통 조건식에서는 비교연산자 (대소,동등),논리연산자(&&,||)를 주로 사용
	
	//조건문은 크게 if 문과 switch 문으로 나뉨
	...
	public void method1( ) {
		 ...
		 *조건식은 if랑 친하다
		 *
		 *> 조건식이 참(true)일 경우 > 중괄호 블럭안의 코드 실행
		 *> 조건식이 거짓(false)일 경우 > 중괄호 블럭안의 코드를 무시하고 넘어감
		 *
		 *
		 */
		...
		public void method2() {
			 ...
			 * }
			 * 
			 * 조건식의 결과가 참(true)일 경우 실행코드 1 수행후 if-else문 빠져나감
			...
			*/
			...
			public void method5( ) {
				...
				*/	
				...
				String name =sc.nextLine();
				String result =""; //변수를 미리 세팅하는 습관을 들이
				System.out.print("성별(M/F):");
				char gender =sc.nextLine().charAt(0);
				String str="";
				if(gender == 'M'||gender=='m') {
			...
			public void method6 ( ) {
				...
				if(name.equals("차은우")) {
					...
					System.out.println("차은우님이 아니신가보네요...ㅠㅠ");
				}
