...
public class B_Switch {
	 ...
	 * 
	 * 실행할 구문만 실행하고 자동으로 빠져나오지 못함(직접 break; 문을 작성해야함)
	 * 
	 * [표현법]
	 * switch (이제부터 동등비교할 대상){
	 * case 값1 : 실행코드1;   break;                     num%5
	 * case 값2 : 실행코드2;	break;
	 * case 값3 : 실행코드3;	break;
	 * 
	 * ...
	 * [default : 위의 값들과 모두 일치하지 않을 경우 실행할 코드;] >if else와 같은 존재
	 * }
	 */
	public void method1( ) {
		/*
		 * 정수를 입력받아 >"정수"
		 * 1일경우 "빨간색 입니다.">case:1 :빨간색입니다; break;
		 * 2일경우 "파란색 입니다.">case:2 :파란색입니다; break;
		 * 3일경우 "초록색 입니다.">case:3 :초록색입니다; break;
		 * 
		...
		*/
		...
		public void method2() {
			 ...
			 int price = 0; //String str=""; 스트링변수는 이렇게 초기화 
